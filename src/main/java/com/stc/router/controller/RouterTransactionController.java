...
public class RouterTransactionController {
    ...
    public Object getTransactions(@RequestParam(value = "num", required = false, defaultValue = "10") Integer num,
        ...
        UriComponentsBuilder urlBuilder = UriComponentsBuilder.fromHttpUrl(routerUrl)
                                                              .path("/cosmos/tx/v1beta1/txs/block/")
                                                              .path(String.valueOf(height))
    ...
    private Object decodeTxs(String encoded) {
        ...
        UriComponentsBuilder urlBuilder = UriComponentsBuilder.fromHttpUrl(routerUrl).path("/cosmos/tx/v1beta1/decode");
